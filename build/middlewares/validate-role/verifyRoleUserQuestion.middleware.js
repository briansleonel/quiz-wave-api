...
exports.verifyRoleUserQuestion = void 0;
 ...
 * @returns
 */
function verifyRoleUserQuestion(req, _res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const questionFound = yield question_repository_1.default.getById(id);
...
exports.verifyRoleUserQuestion = verifyRoleUserQuestion;
